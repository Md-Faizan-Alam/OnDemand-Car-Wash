        ...
        <>
            <div className="container p-5 tab-component">
                ...
                <div className="row user-info-row ">
                    ...
                    <div className="row fs-4 placeholder-glow">{Toolbox.loadString(props.user.email)}</div>
                </div>
                <div className="row user-info-row ">
                    <div className="row text-success">Phone</div>
                    <div className="row fs-4 placeholder-glow">{Toolbox.loadString(props.user.phoneNumber)}</div>
                </div>
                <div className="row user-info-row ">
                    <div className="row text-success">Gender</div>
                    {/* The JsUtils Service is to be used here to change it from all Caps */}
                    <div className="row fs-4 placeholder-glow">{Toolbox.loadString(props.user.gender)}</div>
                </div>
                {/* <div className="row user-info-row ">
