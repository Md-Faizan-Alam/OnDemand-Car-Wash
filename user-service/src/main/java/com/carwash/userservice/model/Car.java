...
public class Car {
	...
	public Car() {}
	public Car(String carId, String modelName, String customerId, String carType, String color,
	...
	public static List<String> getValidCarTypes() {
		return validCarTypes;
	}
	public static void setValidCarTypes(List<String> validCarTypes) {
		Car.validCarTypes = validCarTypes;
	}
